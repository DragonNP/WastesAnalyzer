...
class DataHandler:
    ...
    year_error = 'Введенные данные не являются годом.\nНапишите год еще раз.'
    add_month_error = 'Такого месяца не существует, введите еще раз'
    add_month = 'Отлично! И последний шаг, введите потраченную сумму'
    add_data_success = 'Супер. Данные для анализа добавлены'
    add_data_already = 'В этом месяце уже был добавлен расход.\nДанные для анализа обновлены'
    data_error = 'Введенные данные не являются расходом. Напишите число с запятой или без'
...
class Poll:
    ...
    no = 'Пожалуйста, расскажите что вам не хватает?\n' \
